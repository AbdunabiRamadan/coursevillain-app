...
Section
  ...
  DetailPrint "Register CourseVillain URI Handler"
  DeleteRegKey HKCR "coursevillain"
  WriteRegStr HKCR "coursevillain" "" "URL:coursevillain"
  WriteRegStr HKCR "coursevillain" "URL Protocol" ""
  WriteRegStr HKCR "coursevillain\DefaultIcon" "" "$INSTDIR\${APP_NAME}.exe"
  WriteRegStr HKCR "coursevillain\shell" "" ""
  WriteRegStr HKCR "coursevillain\shell\Open" "" ""
  WriteRegStr HKCR "coursevillain\shell\Open\command" "" "$INSTDIR\${APP_NAME}.exe %1"
...
Section "Uninstall"
  ...
  DetailPrint "delete CourseVillain URI Handler"
  DeleteRegKey HKCR "coursevillain"
